...
export class News extends Component {
  ...
  async updateNews(){
    const url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=8f542ee588c4486ab5f6e5ec14a6a9cf&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <div className="container my-3">
        <h2 className="text-center" style={{margin: '35px 0px'}}>NewsMonkey - Top Headlines from
